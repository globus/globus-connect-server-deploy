...
ARG REPO_SUFFIX=installers/repo/deb/globus-toolkit-repo_latest_all.deb
...
RUN \
    ...
    APT_KEY_DONT_WARN_ON_DANGEROUS_USAGE=1 apt-key add /usr/share/globus-toolkit-repo/RPM-GPG-KEY-Globus ;\
    apt-get update                                                                                       ;\
